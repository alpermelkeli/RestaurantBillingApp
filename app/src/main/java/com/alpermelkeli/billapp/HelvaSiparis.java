...
public class HelvaSiparis extends AppCompatActivity {
    private FirebaseFirestore firestore;
    private StorageReference storage;
    RecyclerView recyclerViewHelva;
    String masaId;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_helva_siparis);
    ...
    private void retrieveSogukUrunler() {
        ...
        urunlerCollectionRef.whereEqualTo("kategori", "helva")
                .get()
                .addOnSuccessListener(queryDocumentSnapshots -> {
                    ...
                    for (DocumentSnapshot document : queryDocumentSnapshots) {
                        ...
                        String resimDosyaAdi = "Products/helva/" + document.getString("urunAdi") + ".jpg";
                    ...
                    recyclerViewHelva.setAdapter(adapter);
                })
            ...
            public void bind(Product product) {
                ...
                imageView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(HelvaSiparis.this,SiparisOnay.class);
