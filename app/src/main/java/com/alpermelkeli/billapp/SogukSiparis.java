...
public class SogukSiparis extends AppCompatActivity {
    private FirebaseFirestore firestore;
    private StorageReference storage;
    RecyclerView recyclerViewSoguk;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soguk_icecek_siparis);
    ...
    private void retrieveSogukUrunler() {
        ...
        urunlerCollectionRef.whereEqualTo("kategori", "soguk")
                .get()
                .addOnSuccessListener(queryDocumentSnapshots -> {
                    ...
                    for (DocumentSnapshot document : queryDocumentSnapshots) {
                        ...
                        String resimDosyaAdi = "Products/soguk/" + document.getString("urunAdi") + ".jpg";
                    ...
                    recyclerViewSoguk.setAdapter(adapter);
                })
            ...
            public void bind(Product product) {
                ...
                imageView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(SogukSiparis.this,SiparisOnay.class);
